...
SRC_URI_append = " \
    ...
    https://raw.githubusercontent.com/rfmoz/grafana-dashboards/73427563c80cb145f764462cd362c60f20358060/LICENSE;name=lic;downloadfilename=LICENSE-node-exporter-full \
"
...
do_install_append() {
    ...
    cp -f ${WORKDIR}/LICENSE-node-exporter-full ${D}/${USRBINPATH}/grafana/conf/provisioning/dashboards/
