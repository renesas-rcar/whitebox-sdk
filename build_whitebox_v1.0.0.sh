...
AOS_VERSION="v1.0.0"
WHITEBOX_VERSION="v1.0.0"
DOMD_OLD_SIZE="1024 MiB"
DOMD_NEW_SIZE="2048 MiB"
DOMD_NEW_SOURCE='
      - type: git
        url: https://github.com/yhamamachi/meta-rcar-dev-utils.git
        rev: "whitebox_sdk_v1.x"'
IMAGE_INSTALL_DOMD="        - [IMAGE_INSTALL_append, \" waii packagegroup-system-monitor iproute2-tc\"]"
...
DOMD_BITBAKE_NEW_LAYER="        - \"../meta-rcar-dev-utils/meta-rcar-common\""
...
sed -i "s|\(rev: \"v6.0.2\"\)|\1${DOMD_NEW_SOURCE//$'\n'/\\n}|" aos-rcar-gen4.yaml
...
git clone https://github.com/xen-troops/meta-xt-prod-devel-rcar-gen4 -b spider-0.8.6 \
